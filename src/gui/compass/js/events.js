 ...
 * Arguments: NONE
*/
window.electronAPI.compass_rx_title((_event,title) =>{
  document.getElementById("title").innerHTML = title;
  document.title = title + " (rotcctlGUI)";
});
 ...
 *
 * DOM items affected:
 * . stopSouth                  (gui/compass/compass.html)
 * . stopNorth                  (gui/compass/compass.html)
 *
 * Arguments: NONE
*/
